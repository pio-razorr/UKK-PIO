            ...
            <div class="row mb-5 details d-flex justify-content-center">
                ...
                <div class="row content">
                    <div class="col-lg-5 d-flex justify-content-center align-content-center" data-aos="fade-right">
                        <div class="d-flex align-items-center w-50">
                            <img src="assets/img/apple-touch-icon.webp" class="img-fluid rounded-4" alt="">
                        </div>
                    </div>
                    <div class="col-lg-7 pt-4" data-aos="fade-up">
                        ...
                        <!-- <p>
                                Kami menjamin keamanan file cheat yang kami sediakan dari virus berbahaya. Saat file cheat terdeteksi oleh anti virus, file tersebut dilindungi dan dienkripsi untuk mencegah deteksi. Anda tidak perlu mematikan anti virus, cukup tambahkan file cheat ke pengaturan pengecualian anti virus.
                              </p> -->
                    </div>
                </div>
                ...
                <div class="row content">
                    <div class="col-lg-5 order-1 order-lg-2 d-flex align-content-center" data-aos="fade-left">
                        <img src="assets/img/Fasilitas vip dc.webp" class="img-fluid rounded-4" alt="">
                    </div>
            ...
            <div class="row mb-5" data-aos="fade-left">
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="50">
                        <img src="assets/img/logo/ml.webp" class="img-fluid me-2" width="140" alt=""
                            srcset="">
                        <!-- <i class="ri-money-dollar-circle-line" style="color: #ffbb2c;"></i> -->
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="100">
                        <img src="assets/img/logo/pubgm.webp" class="img-fluid me-2" width="100" alt=""
                            srcset="">
                        <!-- <i class="ri-computer-line" style="color: #5578ff;"></i> -->
                        <!-- <h3>PUBG Mobile</h3> -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4 mt-md-0">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="150">
                        <img src="assets/img/logo/codm.webp" class="img-fluid me-2" width="200" alt=""
                            srcset="">
                        <!-- <i class="ri-computer-line" style="color: #e80368;"></i> -->
                        <!-- <h3>COD Mobile</h3> -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4 mt-lg-0">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="200">
                        <img src="assets/img/logo/aov.webp" class="img-fluid me-2" width="150" alt=""
                            srcset="">
                        <!-- <i class="ri-customer-service-line" style="color: #e361ff;"></i> -->
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="350">
                        <img src="assets/img/logo/pb.webp" class="img-fluid me-2" width="200" alt=""
                            srcset="">
                        <!-- <i class="ri-hashtag" style="color: #11dbcf;"></i> -->
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="400">
                        <img src="assets/img/logo/8bp.webp" class="img-fluid me-2" width="180" alt=""
                            srcset="">
                        <!-- <i class="ri-apps-line" style="color: #ffa76e;"></i> -->
                        <!-- <h3>8 Ball Poll</h3> -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="450">
                        <img src="assets/img/logo/f84.webp" class="img-fluid me-2" width="220" alt=""
                            srcset="">
                        <!-- <i class="ri-download-line" style="color: #47aeff;"></i> -->
                        <!-- <h3>Farlight84</h3> -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="500">
                        <img src="assets/img/logo/ls.webp" class="img-fluid me-2" width="180" alt=""
                            srcset="">
                        <!-- <i class="ri-chat-1-line" style="color: #4233ff;"></i> -->
                        <!-- <h3>Lost Saga</h3> -->
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="550">
                        <img src="assets/img/logo/fa.webp" class="img-fluid me-2" width="200" alt=""
                            srcset="">
                        <!-- <i class="ri-chat-1-line" style="color: #4233ff;"></i> -->
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-4">
                    <div class="icon-box d-flex justify-content-center rounded-4 h-100" data-aos="zoom-in"
                        data-aos-delay="550">
                        <img src="assets/img/logo/contra.webp" class="img-fluid me-2" width="200" alt=""
                            srcset="">
                        <!-- <i class="ri-chat-1-line" style="color: #4233ff;"></i> -->
                        <!-- <h3>Forward Assault</h3> -->
                    </div>
            ...
            <div class="row g-0" data-aos="fade-left">
                ...
                <div class="col-lg-4 col-md-4 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
                        <a href="{{ asset('assets/img/gallery/pb-1.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK ZEPETTO">
                            <img src="{{ asset('assets/img/gallery/pb-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
                        <a href="{{ asset('assets/img/gallery/pb-2.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK ZEPETTO">
                            <img src="{{ asset('assets/img/gallery/pb-2.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 d-none d-sm-block">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
                        <a href="{{ asset('assets/img/gallery/pb-3.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK ZEPETTO">
                            <img src="{{ asset('assets/img/gallery/pb-3.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
                        <a href="{{ asset('assets/img/gallery/ml-1.webp') }}" class="gallery-lightbox"
                            data-description="MOBILE LEGENDS: BANG BANG">
                            <img src="{{ asset('assets/img/gallery/ml-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                        <a href="{{ asset('assets/img/gallery/ml-2.webp') }}" class="gallery-lightbox"
                            data-description="MOBILE LEGENDS: BANG BANG">
                            <img src="{{ asset('assets/img/gallery/ml-2.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
                        <a href="{{ asset('assets/img/gallery/ml-3.webp') }}" class="gallery-lightbox"
                            data-description="MOBILE LEGENDS: BANG BANG">
                            <img src="{{ asset('assets/img/gallery/ml-3.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                        <a href="{{ asset('assets/img/gallery/ml-4.webp') }}" class="gallery-lightbox"
                            data-description="MOBILE LEGENDS: BANG BANG">
                            <img src="{{ asset('assets/img/gallery/ml-4.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
                        <a href="{{ asset('assets/img/gallery/ppp-1.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK PRIVATE SERVER PROJECT BLACKSHOT">
                            <img src="{{ asset('assets/img/gallery/ppp-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="500">
                        <a href="{{ asset('assets/img/gallery/ppp-2.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK PRIVATE SERVER BETA">
                            <img src="{{ asset('assets/img/gallery/ppp-2.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="550">
                        <a href="{{ asset('assets/img/gallery/ppp-3.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK PRIVATE SERVER BTG (Back To Gemscool)">
                            <img src="{{ asset('assets/img/gallery/ppp-3.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="600">
                        <a href="{{ asset('assets/img/gallery/ppp-4.webp') }}" class="gallery-lightbox"
                            data-description="POINT BLANK PRIVATE SERVER MINIMAX">
                            <img src="{{ asset('assets/img/gallery/ppp-4.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="650">
                        <a href="{{ asset('assets/img/gallery/codm-1.webp') }}" class="gallery-lightbox"
                            data-description="CALL OF DUTY : MOBILE">
                            <img src="{{ asset('assets/img/gallery/codm-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="700">
                        <a href="{{ asset('assets/img/gallery/pubgm-1.webp') }}" class="gallery-lightbox"
                            data-description="PUBG MOBILE">
                            <img src="{{ asset('assets/img/gallery/pubgm-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="750">
                        <a href="{{ asset('assets/img/gallery/aov-1.webp') }}" class="gallery-lightbox"
                            data-description="ARENA OF VALOR">
                            <img src="{{ asset('assets/img/gallery/aov-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="800">
                        <a href="{{ asset('assets/img/gallery/8bp-1.webp') }}" class="gallery-lightbox"
                            data-description="8 BALL POOL">
                            <img src="{{ asset('assets/img/gallery/8bp-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="850">
                        <a href="{{ asset('assets/img/gallery/lsovvip-1.webp') }}" class="gallery-lightbox"
                            data-description="FARLIGHT 84">
                            <img src="{{ asset('assets/img/gallery/lsovvip-1.webp') }}" alt=""
                                class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="900">
                        <a href="{{ asset('assets/img/gallery/lsovvip-2.webp') }}" class="gallery-lightbox"
                            data-description="LOST SAGA ORIGIN VVIP">
                            <img src="{{ asset('assets/img/gallery/lsovvip-2.webp') }}" alt=""
                                class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="950">
                        <a href="{{ asset('assets/img/gallery/lsovvip-3.webp') }}" class="gallery-lightbox"
                            data-description="LOST SAGA ORIGIN VVIP">
                            <img src="{{ asset('assets/img/gallery/lsovvip-3.webp') }}" alt=""
                                class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="1000">
                        <a href="{{ asset('assets/img/gallery/lsovvip-4.webp') }}" class="gallery-lightbox"
                            data-description="LOST SAGA ORIGIN VVIP">
                            <img src="{{ asset('assets/img/gallery/lsovvip-4.webp') }}" alt=""
                                class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="1050">
                        <a href="{{ asset('assets/img/gallery/contra-1.webp') }}" class="gallery-lightbox"
                            data-description="CONTRA TOURNAMENT">
                            <img src="{{ asset('assets/img/gallery/contra-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="1050">
                        <a href="{{ asset('assets/img/gallery/contra-2.webp') }}" class="gallery-lightbox"
                            data-description="CONTRA TOURNAMENT">
                            <img src="{{ asset('assets/img/gallery/contra-2.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="1050">
                        <a href="{{ asset('assets/img/gallery/f84-1.webp') }}" class="gallery-lightbox"
                            data-description="FARLIGHT 84">
                            <img src="{{ asset('assets/img/gallery/f84-1.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="1050">
                        <a href="{{ asset('assets/img/gallery/f84-2.webp') }}" class="gallery-lightbox"
                            data-description="FARLIGHT 84">
                            <img src="{{ asset('assets/img/gallery/f84-2.webp') }}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
